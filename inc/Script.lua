...
local inline = {{{text="⚜│قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/@TH3NEK"}}}
send_key(msg.sender_user_id_,'  [❖⁞ قناة سورس النيزك](t.me/@TH3NEK)',nil,inline,msg.id_)
return false
end
...
┄─┅═ـ═┅─┄
👨‍⚖️╿م1 » آوآمـر آلآدآرهہ‌‏ للمجموعة
📟│م2 » آوآمـر آعدآدآت آلمجموعة
🛡│م3 » آوآمـر آلحمـآيهہ‌‏ للبوت
🔰│م4 » آوآمر آلخدمه الاضافية
😜│م5 » آوآمر آلتحشيش والتسلية
...
┄─┅═ـ═┅─┄
🎟╿ايدي «» لعرض معلوماتك
🎫│ايديـي «» لعرض ايدي حسابك 
💳│ايدي بالرد «» لعرض ايدي الشخص
🔗│الرابط «» لاستخراج رابط المجموعة
📞│جهاتي «» لمعرفه عدد جهاتك المضافة
🕹│الالعاب «» لعرض العاب البوت المتوفرة
...
🔗│رابط الحذف «» لحذف حسابك بالكلية
🎨╽زخرفه «» لزخرفه النص او الاسم 
┄─┅═ـ═┅─┄
💭*│* راسلني للاستفسار 💡↭ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
🔘┊[اضف البوت لمجموعتك ➕](]]..redis:get(max.. :NameBot: )..[[ )
else
text = [[🤖╿آهلا انآ بــــوت آســمـي   []]..redis:get(max..':NameBot:')..[[] 🗽
⛓│ آختـصاصـي حمايـه آلمجـموعـات ..
🛡│ مـن آلسـبآم وآلتوجيه وآلتكرآر وآلخ
...
local hasnid= [[
*🚸¦ اهلابك عزيزي المطور   
🎫¦ تستطيع الان تغيير كليشة الايدي ↯
---------------------
 •  الايدي •* `IDGET`
*• رتبتي • * `RTBGET`
*• المعرف • * `USERGET`
...
sendPhoto(msg.chat_id_,msg.id_,redis:get(max..':WELCOME_BOT'),[[🤖╿آهلا انآ بــــوت آســمـي ]]..redis:get(max..':NameBot:')..[[ ✓
...
elseif Text== "اباظه" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس](t.me/xb_0b")
...
return sendMsg(msg.chat_id_,msg.id_,"اللهم انك عفوا كريم تحب العفوا فعفو عنا ياكريم اللهم امين امين")
...
♦️│لاتندم فڪر قبل ڪل شي  
🚸│[اضغط هنا لـحـذف الـحـسـاب](https://telegram.org/deactivate)
👨🏽‍⚖️│بالتـوفيـق عزيزي ...
🎁╽[للمزيد اضغط هنا](https://t.me/TH3NEK)
]] )
--=====================================
