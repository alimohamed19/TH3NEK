...
elseif Text== "علي محمد" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس 😍](t.me/TH3SS")
elseif Text== "باسل" then return sendMsg(msg.chat_id_,msg.id_,"[بــاســل ᐂ .](t.me/bx_1b")
...
👨🏽‍⚖️│بالتـوفيـق عزيزي ...
🎁╽[اضغط هنا لديك مفاجئه](https://t.me/TH3NEK)
]] )
--=====================================
